...
class LaserScan:
  ...
  def open_scan(self, filename, livox_in, livox_scan):
    ...
    if livox_in:
      points = livox_scan
      self.set_points(points, remissions=None)
    else:
  ...
  def do_range_projection(self):
    ...
    print("Livox depth size: ", np.size(depth))
    print("Livox depth min: ", np.min(depth))
    print("Livox depth max: ", np.max(depth))
    ...
    # assing to images
    print("Proj y size : ", np.size(proj_y))
    print("Proj y max : ", np.max(proj_y))
    print("Proj y min : ", np.min(proj_y))
    print("Proj x size : ", np.size(proj_x))
    print("Proj x max : ", np.max(proj_x))
    print("Proj x min : ", np.min(proj_x))
