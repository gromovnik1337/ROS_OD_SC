...
int main (int argc, char** argv) {
  ...
  // Set the resulotion variables values
  ...
  //viewer.addPointCloud (point_cloud, range_image_color_handler, "range image");
  ...
  // Main loop - for the viewer and visualization
  while (!viewer.wasStopped ())
  {
    ...
    // Live update handling - update the range image according to the current view in the visualizer
    if (live_update)
    {
